...
<title>Sign Up Form by Subhajit</title>
...
<input type="hidden" id="status"value="<%= request.getAttribute("status") %>">
	...
	if(status=="invaliedName")
	{
	swal("congrats","please enter Name","error");
	}
	if(status=="invaliedEmail")
	{
	swal("congrats","Please Enter Email","error");
	}
	if(status=="invaliedUpwd")
	{
	swal("congrats","Please Enter password","error");
	}
	if(status=="invaliedconfirmpassword")
	{
	swal("congrats","password do not match","error");
	}
	if(status=="invaliedMobile")
	{
	swal("congrats","invaliedMobile","error");
	}
	if(status=="invaliedMobileLength")
	{
	swal("congrats","invaliedMobile","error");
	}
